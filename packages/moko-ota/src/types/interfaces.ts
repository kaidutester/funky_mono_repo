...
/**
 * string for OTA types, represents the hex value of byte array
 * used for Moko OTA firmware update
 */
export enum OTA_TYPES {
  FIRMWARE = '01',
  CA_ROOT_CERTIFICATE = '02',
  CLIENT_CERTIFICATE = '04',
}
