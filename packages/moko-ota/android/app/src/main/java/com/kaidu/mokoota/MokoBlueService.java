...
public class MokoBlueService extends Service implements MokoConnStateCallback, MokoOrderTaskCallback {
    ...
    public void onConnectSuccess() {
        ...
        Log.d("MokoModule", "onConnectSuccess: EventBus post connectStatusEvent event");
    }
    ...
    public void onOrderResult(OrderTaskResponse response) {
        Log.d("MokoModule", "onOrderResult of MokoBlueService");
        ...
        // @Asher add notificationID as a workaround to avoid duplicates
        // https://stackoverflow.com/questions/21314126/android-broadcastreceiver-onreceive-called-twice-on-android-4-0
        UUID uuid = UUID.randomUUID();
        String uuidAsString = uuid.toString();
        intent.putExtra("notificationID", uuidAsString);

        this.context.sendOrderedBroadcast(intent, null);
        Log.d("MokoModule", "onOrderResult: send order result broadcast");
    }
    ...
    public void onOrderTimeout(OrderTaskResponse response) {
        ...
        intent.putExtra(MokoConstants.EXTRA_KEY_RESPONSE_ORDER_TASK, response);
        this.context.sendOrderedBroadcast(intent, null);
        Log.d("MokoModule", "onOrderTimeout: send order timeout broadcast");
        //emit event to React Native
    }

    @Override
    public void onOrderFinish() {
        this.context.sendBroadcast(new Intent(MokoConstants.ACTION_ORDER_FINISH));
    }

    @Override
    public void onCreate() {
        LogModule.i("创建MokoBlueService...onCreate");
        mHandler = new com.kaidu.mokoota.MokoBlueService.ServiceHandler(this);
        super.onCreate();
    }
    ...
    public void disConnectBle() {
        ...
        Log.d("MokoModule", "BLE disconnected");
    }
    ...
    public void onLowMemory() {
        ...
        Log.d("MokoModule", "内存吃紧，销毁MokoBlueService...onLowMemory");
        disConnectBle();
        super.onLowMemory();
    }
    ...
    public void onDestroy() {
        ...
        Log.d("MokoModule", "销毁MokoBlueService...onDestroy");
        disConnectBle();
        super.onDestroy();
    }
    ...
    public MokoBlueService.ServiceHandler mHandler;
