...
public class MokoConstants {
    ...
    //native module - MokoModule - for React Native
    public static final String EVENT_ONORDER = "onOrderTask"; // Event for order tasks
    public static final String EVENT_ONUPDATE = "onUpdate"; //Event for firmware update result, i.e. OTA result 
}
